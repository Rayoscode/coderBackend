...
processRouter.get('/info', (req, res) => {
    res.json({ argv: process.argv, os: os.platform(), node: process.version, mem: process.memoryUsage(), path: process.cwd(), pid: process.pid, fpath: path.basename(process.execPath) })
})
